...
/**
 Sets data to card text field
 */
//- (void)setCardParamText:(nullable NSString *)cardType withData:(nullable NSString *)data_str;

- (void)setText:(nullable NSString *)text inField:(STPCardFieldType)field;
